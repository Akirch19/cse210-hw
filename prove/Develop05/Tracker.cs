    ...
    public void LoadGoals()
    {
        ...
        for (int i = 1; i < lines.Count(); i++ )
        {
            ...
            if (parts[0] == "Simple") {
                ...
                Simple simple = new Simple(parts[1], parts[2], Convert.ToInt32(parts[3]), Convert.ToBoolean(parts[4]));
                _goals.Add(simple);             

            } else if (parts[0] == "Eternal") {

                Eternal eternal = new Eternal(parts[1], parts[2], Convert.ToInt32(parts[3]));
                _goals.Add(eternal);

            } else if (parts[0] == "Checklist") {
                
                Checklist checklist = new Checklist(parts[1], parts[2], Convert.ToInt32(parts[3]), Convert.ToInt32(parts[4]), Convert.ToInt32(parts[5]), Convert.ToInt32(parts[6]));
